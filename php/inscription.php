...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        // Exemple : stocker dans la session un tableau associatif
        $_SESSION['user'] = [
            'login'  => $email,
            'prenom' => $name,
            'role'   => 'user'
        ...
        // Vous pourriez ajouter ici un code pour enregistrer l'utilisateur dans une base de données ou un fichier JSON
