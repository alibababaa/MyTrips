...
// Si coordonnées bancaires soumises → enregistrer transaction + rediriger
if (isset($_POST['card_number'], $_POST['card_owner'], $_POST['expiry_date'], $_POST['cvv'])) {
    ...
    foreach ($selectedTrips as $trip) {
        ...
        $transactions[] = [
            ...
            'prix_total' => $infos['prix_total'],
            'montant' => $infos['prix_total'],
    ...
    header("Location: confirmation.php?batch=" . urlencode($batchId));
    exit();
}
?>
<!DOCTYPE html>
...
<form action="paiement.php" method="POST" style="max-width: 600px; margin: 2em auto;">
    ...
    <!-- Champs cachés pour renvoyer les données originales -->
